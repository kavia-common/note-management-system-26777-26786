package com.example.notesmanagerbackend;
...
@RestController
@Tag(name = "Hello Controller", description = "Basic endpoints for notesmanagerbackend")
public class HelloController {
    
    @GetMapping("/")
    @Operation(summary = "Welcome endpoint", description = "Returns a welcome message")
    public String hello() {
        return "Hello, Spring Boot! Welcome to notesmanagerbackend";
    }
    ...
    public String info() {
        return "Spring Boot Application: notesmanagerbackend";
    }
} 